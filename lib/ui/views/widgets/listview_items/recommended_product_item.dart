...
import 'package:monibie/ui/views/pages/product_details.dart';
...
class RecommendedProductItem extends StatelessWidget{
  ...
  RecommendedProductItem({Key key, this.dummyProduct, this.index, this.fromProductDetailsScreen = false}) : super(key: key);
                  ...
                  children: [
                    ...
                    index == 1 || index == 3 ? Container() : Positioned(
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            color: fromProductDetailsScreen ? orangeRed : dodgerBlue,
